...
\author{Petr Baudi\v{s}\\
	...
	Department of Cybernetics\\
	Technick\'{a} 2, Prague,\\Czech Republic\\
	{\tt stanksil@fel.cvut.cz}
	\And
	Jan \v{S}ediv\'{y} \\
	FEE CTU Prague\\
	Department of Cybernetics\\
	Technick\'{a} 2, Prague,\\Czech Republic\\
	{\tt sedivjan@fel.cvut.cz}}
...
A typical approach \cite{YodaQAanother}, used implicitly in information retrieval
(and its extensions, like IR-based Question Answering systems \cite{YodaQA}),
...
based on evidence \cite{RTE} \cite{SNLI} \cite{SICK2014}
...
In this work, we seek to fuse information retrieva and textual entaiment
...
the Augur prediction market. \cite{Argus}  Here, we consider it within
the constraints of a practical task that has limited available dataset
...
and a neural model within the Sentence Pair Scoring framework \cite{sts}
...
as linear classifier inputs, and (C) aggregates all available evidence
...
We'd like to thank Perry Despeiges of the Augur Project for his support.}
