...
led us to investigate this model.  % TODO details
...
Regarding concrete limitations of our models, in the case of the Argus task,
the main source of failures is dependency on a particular named entity.
The more obvious form is \textit{Had Roger Federer beat Martin Cilic in US OPEN 2014?}
...
of named entities which cannot be meaningfully embedded in a GloVe-like
